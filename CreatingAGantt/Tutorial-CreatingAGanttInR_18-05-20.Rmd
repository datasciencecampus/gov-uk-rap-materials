...
I created the above table in excel and saved as `csv` formatted text file to read into R. For setting the styles with `css` code take alook at [this](https://www.w3schools.com/html/html_css.asp) tutorial.
